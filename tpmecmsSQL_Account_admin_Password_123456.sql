...
-- ----------------------------
BEGIN;
INSERT INTO `fa_admin` VALUES (1, 'admin', 'Admin', '7058fdb42a4f1cf01b7a3bf1d9845d57', 'KN8o3s', '/assets/img/avatar.png', '496631085@qq.com', 0, 1627635908, '114.223.141.166', 1491635035, 1627635908, '98052f9f-101c-4fe9-ac75-9b20470260d0', 'normal');
COMMIT;
...
CREATE TABLE `fa_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=574 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员日志表';
...
CREATE TABLE `fa_auth_rule` (
  ...
  KEY `pid` (`pid`),
  KEY `weigh` (`weigh`)
) ENGINE=InnoDB AUTO_INCREMENT=293 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='节点表';
...
INSERT INTO `fa_auth_rule` VALUES (286, 'file', 0, 'command', '在线命令管理', 'fa fa-terminal', '', '', '', 1, NULL, '', 1625232304, 1625232304, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (287, 'file', 286, 'command/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 1625232304, 1625232304, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (288, 'file', 286, 'command/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 1625232304, 1625232304, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (289, 'file', 286, 'command/detail', '详情', 'fa fa-circle-o', '', '', '', 0, NULL, '', 1625232304, 1625232304, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (290, 'file', 286, 'command/execute', '运行', 'fa fa-circle-o', '', '', '', 0, NULL, '', 1625232304, 1625232304, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (291, 'file', 286, 'command/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 1625232304, 1625232304, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (292, 'file', 286, 'command/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 1625232304, 1625232304, 0, 'normal');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COMMENT='栏目管理';
...
INSERT INTO `fa_cate` VALUES (59, 'list', 0, 0, '信息动态', '', '', '', '', '', '', 0, 28, '', 'news', 'show', 2, 1, 1624068742, 1626656034, '1', 'news', 'fa_news');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统配置';
...
INSERT INTO `fa_config` VALUES (22, 'wx_app_id', 'weixin', '公众号Appid', '微信公众号Appid', 'string', 'wxe8ed1781937ff05c', '', '', '', '{\"table\":\"\",\"conditions\":\"\",\"key\":\"\",\"value\":\"\"}');
...
CREATE TABLE `fa_news` (
  ...
  KEY `weigh` (`weigh`,`id`)
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8mb4 COMMENT='信息动态';

-- ----------------------------
-- Records of fa_news
-- ----------------------------
BEGIN;
INSERT INTO `fa_news` VALUES (1, 'TpMeCMS后台添加和编辑页面的文件下拉等输入框代码替换', '/cms/images/s01.jpg', '/cms/images/s01.jpg', '', '', 'TpMeCMS', 'admin,view,后台html,上传视频,上传多图', 0, 29, NULL, 1626750254, NULL, NULL, '', '<p><b>1</b></p>', '1');
INSERT INTO `fa_news` VALUES (111, 'TpMeCMS介绍及下载地址', '/cms/images/news-1.jpg', '/cms/images/news-1.jpg', '', '', '', '标签,分割', 111, 51, 1624004284, 1627722058, 1624004236, NULL, '', '<p>TpMeCMS开源地址Gitee：&nbsp;&nbsp;<a href=\"https://gitee.com/xiaohe4966/tp-me-cms\" target=\"_blank\">https://gitee.com/xiaohe4966/tp-me-cms</a></p><p>完整静态打包地址Github：&nbsp;<a href=\"https://github.com/xiaohe4966/TpMeCMS\">https://github.com/xiaohe4966/TpMeCMS</a><a href=\"https://github.com/xiaohe4966/TpMeCMS\"></a></p><p><br></p><p>完整示例网站：<a href=\"http://yunshang.he4966.cn/cms/index/index\" target=\"_blank\">http://yunshang.he4966.cn/cms/index/index</a>  <script src=\'https://gitee.com/xiaohe4966/tp-me-cms/widget_preview\' async defer></script>\n<div id=\"osc-gitee-widget-tag\"></div>\n<style>\n.osc_pro_color {color: #4183c4 !important;}\n.osc_panel_color {background-color: #ffffff !important;}\n.osc_background_color {background-color: #ffffff !important;}\n.osc_border_color {border-color: #0671b8 !important;}\n.osc_desc_color {color: #666666 !important;}\n.osc_link_color * {color: #5c095c !important;}\n</style></p>', '1');
INSERT INTO `fa_news` VALUES (112, '员工列表', '/cms/images/news-2.jpg', '/cms/images/services-1.jpg', 'International standard laboratory', '公共服务平台关键字', '/cms/images/services-1.jpg', '', 112, 21, 1624263266, 1624934496, 1624263230, 1624934496, '', '<p>zheshi miaos&nbsp;</p>', '1');
INSERT INTO `fa_news` VALUES (113, 'Fastadmin 后台表格每行数据加按钮弹新页面教程及更具条件显示或隐藏', '', '', '', '', '', '', 113, 17, 1626143944, 1627636259, 1626143865, NULL, '', '<p>在对应的js里面编辑</p><p><br></p><p>找到如下代码：</p><pre><code class=\"lang-js\">    {field: \'operate\', title: __(\'Operate\'), table: table,<br></code></pre><p>并在后面添加：可自行修改</p><pre><code class=\"lang-js\">                        {field: \'operate\', title: __(\'Operate\'), table: table,\r\n                            buttons: [\r\n                                {\r\n                                    name: \'editprice\',\r\n                                    text: \'编辑附近大学\',\r\n                                    title: \'编辑附近大学\',\r\n                                    classname: \'btn btn-xs btn-success btn-dialog\',\r\n                                    icon: \'fa fa-folder-o\',\r\n                                    url: \'shop/yuyue_order2/editprice\'\r\n                                }\r\n                            ], \r\n                            events: Table.api.events.operate, formatter: Table.api.formatter.operate}<br></code></pre><p><br></p><p><br></p><p><br></p><p>如果要更具条件来显示或隐藏该按钮在里面加入</p><pre><code class=\"lang-js\">   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hidden:function(row){\r\n                                            if(row.xiaohe==0){//xiaohe就是这个数据的字段 自行修改\r\n                                                return false; //显示该按钮\r\n                                            }else{\r\n                                                return true;&nbsp;&nbsp;//隐藏该按钮\r\n                                            }\r\n                                        },<br></code></pre><p>示例用法</p><pre><code>       {field: \'operate\', title: __(\'Operate\'), table: table,\r\n                            buttons: [\r\n                                {\r\n                                    name: \'editprice\',\r\n                                    text: \'编辑附近大学\',\r\n                                    title: \'编辑附近大学\',\r\n                                    classname: \'btn btn-xs btn-success btn-dialog\',\r\n                                    icon: \'fa fa-folder-o\',\r\n\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//隐藏按钮条件\r\n   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hidden:function(row){\r\n                                            if(row.end_status==0){  // 自行修改条件\r\n                                                return false; //显示该按钮\r\n                                            }else{\r\n                                                return true;  //隐藏该按钮\r\n                                            }\r\n                                    },\r\n\r\n                                    url: \'shop/yuyue_order2/editprice\'\r\n                                }\r\n                            ], \r\n                            events: Table.api.events.operate, formatter: Table.api.formatter.operate}<br></code></pre>', '1');
INSERT INTO `fa_news` VALUES (114, '宝塔定时任务执行每30秒执行一次', '', '', '', '', '', '', 114, 10, 1626857801, 1626857801, 1626857661, NULL, '', '<p>更改前</p><pre><code class=\"lang-bash\">#!/bin/bash\r\nPATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:~/bin\r\nexport PATH\r\ncurl -sS --connect-timeout 10 -m 3600 \'http://newk3.he4966.cn/api/twhttp/update_data\'\r\necho \"----------------------------------------------------------------------------\"\r\nendDate=`date +\"%Y-%m-%d %H:%M:%S\"`\r\necho \"★[$endDate] Successful\"\r\necho \"----------------------------------------------------------------------------\"\r\n<br></code></pre><p><br></p><p><br></p><p><br></p><p>更改后</p><pre><code class=\"lang-bash\">#!/bin/bash\r\nPATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:~/bin\r\nexport PATH\r\nstep=30 //时间\r\nfor (( i = 0; i &lt; 60; i=(i+step) )); do\r\ncurl -sS --connect-timeout 10 -m 3600 \'http://newk3.he4966.cn/api/twhttp/update_data\'\r\necho \"----------------------------------------------------------------------------\"\r\nendDate=`date +\"%Y-%m-%d %H:%M:%S\"`\r\necho \"★[$endDate] Successful\"\r\necho \"----------------------------------------------------------------------------\"\r\nsleep $step\r\ndone\r\nexit 0\r\n<br></code></pre>', '1');
COMMIT;
